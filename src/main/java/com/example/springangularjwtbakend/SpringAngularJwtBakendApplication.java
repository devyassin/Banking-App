...
import com.example.springangularjwtbakend.dtos.BankAccountDTO;
import com.example.springangularjwtbakend.dtos.CurrentBankAccountDTO;
import com.example.springangularjwtbakend.dtos.CustomerDTO;
import com.example.springangularjwtbakend.dtos.SavingBankAccountDTO;
import com.example.springangularjwtbakend.entities.*;
...
import com.example.springangularjwtbakend.exceptions.CustomerNotFoundException;
...
public class SpringAngularJwtBakendApplication {
    ...
    //@Bean
    CommandLineRunner start(CustomerRepositery customerRepository,
                            BankAccountRepositery bankAccountRepository,
                            AccountOperationRepositery accountOperationRepository){
        return args -> {
